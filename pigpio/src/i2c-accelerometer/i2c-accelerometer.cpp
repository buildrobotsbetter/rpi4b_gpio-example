...
short read2Bytes(int, unsigned char, unsigned char);
...
int main()
{
    ...
    while (isRunning)
    {
        short dataX_1 = read2Bytes(i2cHandle, 0x32, 0x33);
        short dataY_1 = read2Bytes(i2cHandle, 0x34, 0x35);
        short dataZ_1 = read2Bytes(i2cHandle, 0x36, 0x37);
