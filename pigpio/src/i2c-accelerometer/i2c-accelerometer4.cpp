...
int main()
{
    try
    {
        ...
        while (isRunning)
        {
            ...
            axdl345.read(0x32, value);
            dataX_1 = static_cast<int16_t>(value);
            
            axdl345.read(0x34, value);
            dataY_1 = static_cast<int16_t>(value);

            axdl345.read(0x36, value);
            dataZ_1 = static_cast<int16_t>(value);
